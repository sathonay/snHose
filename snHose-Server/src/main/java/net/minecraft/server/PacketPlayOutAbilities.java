...
public class PacketPlayOutAbilities extends Packet
{
    ...
    public PacketPlayOutAbilities(final PlayerAbilities playerAbilities) {
    ...
    @Override
    public String b() {
        return String.format("invuln=%b, flying=%b, canfly=%b, instabuild=%b, flyspeed=%.4f, walkspped=%.4f", this.c(), this.d(), this.e(), this.f(), this.g(), this.h());
    }
