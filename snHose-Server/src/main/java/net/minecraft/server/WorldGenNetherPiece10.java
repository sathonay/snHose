...
public class WorldGenNetherPiece10 extends WorldGenNetherPiece
{
    ...
    public WorldGenNetherPiece10(final int n, final Random random, final StructureBoundingBox f, final int g) {
        super(n);
        this.g = g;
        this.f = f;
    ...
    public boolean a(final World world, final Random random, final StructureBoundingBox structureBoundingBox) {
        ...
        this.a(world, structureBoundingBox, 1, 2, 4, 4, 5, 4, Blocks.NETHER_BRICK, Blocks.NETHER_BRICK, false);
        ...
        if (this.b && structureBoundingBox.b(this.a(1, 3), this.a(2), this.b(1, 3))) {
            this.b = false;
